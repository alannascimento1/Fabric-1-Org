...
# OBS
queryInstalled() {
    setGlobalsForPeer0Org1   #Aqui lembra de executar com Org1 e Orgx
...
# queryInstalled
# Quando executar um dos aprove o query deve está habilitado
...
#OBS
queryCommitted() {
    setGlobalsForPeer0Org1 #LEMBRAR DE FAZER PARA ORG1 E ORGx
